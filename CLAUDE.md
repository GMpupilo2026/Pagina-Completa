...
| [`cuentas-y-formularios`](docs/decisiones/cuentas-y-formularios.md) | Formularios de inscripción y adjuntos, freno de los envíos sin cuenta, encuesta de satisfacción con el profesor, alta de cuentas, alumno sin correo, invitación y bienvenida | formularios, envios-publicos, inscripcion-adjuntos, encuesta-profesor, alumno-sin-correo, bienvenida, admin |
