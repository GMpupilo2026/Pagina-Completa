...
| [`permisos-y-roles`](docs/decisiones/permisos-y-roles.md) | Varios profesores, equipos, subgrupos, coordinación, supervisor y «Ver como» una persona, academias (marca, IA, tablero), roles, funciones de trigger, texto ajeno | varios-profesores, subgrupos, coordinacion, supervisor, ver-como, academias, informe-mensual, mejorar-informe, tablero-academias |
