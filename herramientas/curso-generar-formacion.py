...
{bloques}
            ...
            <div class="mt-10 bg-brand-800 dark:bg-brand-900 rounded-2xl p-6 text-center hidden" id="course-login-cta" hidden>
                ...
                <p class="text-brand-200 text-sm mb-4">Inicia sesión con tu cuenta de Academia para ver las {total} sesiones completas de este curso, con sus recursos descargables.</p>
