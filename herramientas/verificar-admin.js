...
async function pruebaAtajos(browser) {
  ...
  igual("Formularios: todos juntos, con la encuesta de satisfacción", atajos("Formularios"), ["satisfaccion.html", "formularios.html", "solicitudes.html", "inscripciones.html"]);
