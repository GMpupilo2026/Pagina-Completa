...
- Academia: `supabase/migraciones/` — 179 migraciones.
- Inscripciones: `supabase/migraciones-colegios/` — 5.

**Después de aplicarlas, comparar contra el retrato** que está en
`supabase/esquema/inventario-academia.txt`: 62 tablas, 110 funciones, 176
políticas, 20 triggers, 129 índices, 15 tablas en Realtime, 3 tareas de cron.
