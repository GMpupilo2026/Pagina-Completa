// Worker que protege de verdad el contenido de las lecciones de los cursos.
//
// El sitio sigue siendo estático (Cloudflare Workers Assets), pero este script
// se ejecuta antes de servir los archivos y bloquea, en el servidor (no solo
// con CSS/JS en el navegador, que cualquiera puede saltarse):
...
//
// Las páginas de curso en sí (cursos/<curso>.html) — portada, descripción y
// temario completo con el título de cada lección — son públicas: cualquier
// visitante las ve sin iniciar sesión, a propósito, para que sirvan de
// vitrina y motiven a inscribirse en la Academia. Solo el contenido real de
// las lecciones (arriba) exige sesión.
//
