/* El código de crazyhouse.html.
   ...
   docs/decisiones/sitio-e-infraestructura.md. */
        ...
        function esTripleRepeticion(jugadas, fen) {
            return !!window.Repeticion && Repeticion.esTriple(Crazyhouse.START_FEN, jugadas, (f) => new Crazyhouse.Game(f), fen);
        }
        ...
        async function init() {
            ...
            board = new CrazyhouseBoard(
                document.getElementById("board"),
                document.getElementById("top-pocket"),
                document.getElementById("bottom-pocket"),
                {
