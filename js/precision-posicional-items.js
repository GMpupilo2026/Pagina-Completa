...
(function () {
  ...
  const ITEMS = [
    ...
    },
    {
      ...
      fen: "3r2k1/p3bpp1/1pp4p/3p4/8/P2P1PP1/1PP1B2P/3R2K1 w - - 0 26",
      enunciado: "El alfil blanco de e2 apenas tiene movimiento —hoy solo puede ir a f1—, encerrado detrás de sus propios peones centrales, mientras que el negro de e7 sí tiene diagonales libres. ¿Cuál es el plan correcto?",
      opciones: [
        "Cambiar los alfiles a la primera oportunidad que aparezca.",
        "Preparar d3-d4 o f3-f4, para abrirle al alfil la salida hacia c4 o hacia g2.",
        "Renunciar a mejorar el alfil y jugar todo el plan en el otro flanco.",
        "Retroceder el alfil a d1, resignándose a que quede pasivo para siempre.",
      ],
      correcta: 1,
      explica: "Un alfil «malo» casi siempre se puede rescatar despejándole una diagonal con un avance de peón: acá d3-d4 o f3-f4 le abren a e2 la salida hacia c4 o hacia g2, sacándolo de detrás de la cadena que hoy lo deja con una sola jugada (Af1). Cambiar alfiles (A) es justo lo que NO conviene cuando el propio es el peor —es el rival quien gana con ese cambio—; ignorar la pieza (C) deja una pieza floja para el resto de la partida; retroceder el alfil sin plan (D) lo confirma como una pieza mala en vez de rescatarlo.",
      fuente: "Posición ilustrativa: alfil de casillas claras encerrado por su propia cadena de peones centrales, con la salida disponible tras un avance de peón.",
    },
    {
      id: "pp_mejorar_03_h", area: "mejorar_pieza", dificultad: 2, turno: "blancas",
      fen: "1k2r3/1ppb3p/p4pp1/4p3/8/1PP1P2P/P2B1PP1/1K2R3 w - - 0 20",
      enunciado: "El alfil blanco de d2 apenas tiene movimiento —hoy solo puede ir a c1—, encerrado detrás de sus propios peones centrales, mientras que el negro de d7 sí tiene diagonales libres. ¿Cuál es el plan correcto?",
      opciones: [
        "Cambiar los alfiles a la primera oportunidad que aparezca.",
        "Preparar e3-e4 o c3-c4, para abrirle al alfil la salida hacia f4 o hacia b2.",
        "Renunciar a mejorar el alfil y jugar todo el plan en el otro flanco.",
        "Retroceder el alfil a e1, resignándose a que quede pasivo para siempre.",
      ],
      correcta: 1,
      explica: "Un alfil «malo» casi siempre se puede rescatar despejándole una diagonal con un avance de peón: acá e3-e4 o c3-c4 le abren a d2 la salida hacia f4 o hacia b2, sacándolo de detrás de la cadena que hoy lo deja con una sola jugada (Ac1). Cambiar alfiles (A) es justo lo que NO conviene cuando el propio es el peor —es el rival quien gana con ese cambio—; ignorar la pieza (C) deja una pieza floja para el resto de la partida; retroceder el alfil sin plan (D) lo confirma como una pieza mala en vez de rescatarlo.",
      fuente: "Posición ilustrativa: alfil de casillas oscuras encerrado por su propia cadena de peones centrales, con la salida disponible tras un avance de peón.",
    },
    {
      id: "pp_mejorar_03_v", area: "mejorar_pieza", dificultad: 2, turno: "negras",
      fen: "3r2k1/1pp1b2p/p2p1pp1/8/3P4/1PP4P/P3BPP1/3R2K1 b - - 0 20",
      enunciado: "El alfil negro de e7 apenas tiene movimiento —hoy solo puede ir a f8—, encerrado detrás de sus propios peones centrales, mientras que el blanco de e2 sí tiene diagonales libres. ¿Cuál es el plan correcto?",
      opciones: [
        "Cambiar los alfiles a la primera oportunidad que aparezca.",
        "Preparar d6-d5 o f6-f5, para abrirle al alfil la salida hacia c5 o hacia g7.",
        "Renunciar a mejorar el alfil y jugar todo el plan en el otro flanco.",
        "Retroceder el alfil a d8, resignándose a que quede pasivo para siempre.",
      ],
      correcta: 1,
      explica: "Un alfil «malo» casi siempre se puede rescatar despejándole una diagonal con un avance de peón: acá d6-d5 o f6-f5 le abren a e7 la salida hacia c5 o hacia g7, sacándolo de detrás de la cadena que hoy lo deja con una sola jugada (Af8). Cambiar alfiles (A) es justo lo que NO conviene cuando el propio es el peor —es el rival quien gana con ese cambio—; ignorar la pieza (C) deja una pieza floja para el resto de la partida; retroceder el alfil sin plan (D) lo confirma como una pieza mala en vez de rescatarlo.",
      fuente: "Posición ilustrativa: alfil de casillas oscuras encerrado por su propia cadena de peones centrales, con la salida disponible tras un avance de peón.",
    },
    {
      id: "pp_mejorar_03_hv", area: "mejorar_pieza", dificultad: 2, turno: "negras",
      fen: "1k2r3/p2b1pp1/1pp1p2p/8/4P3/P4PP1/1PPB3P/1K2R3 b - - 0 20",
      enunciado: "El alfil negro de d7 apenas tiene movimiento —hoy solo puede ir a c8—, encerrado detrás de sus propios peones centrales, mientras que el blanco de d2 sí tiene diagonales libres. ¿Cuál es el plan correcto?",
      opciones: [
        "Cambiar los alfiles a la primera oportunidad que aparezca.",
        "Preparar e6-e5 o c6-c5, para abrirle al alfil la salida hacia f5 o hacia b7.",
        "Renunciar a mejorar el alfil y jugar todo el plan en el otro flanco.",
        "Retroceder el alfil a e8, resignándose a que quede pasivo para siempre.",
      ],
      correcta: 1,
      explica: "Un alfil «malo» casi siempre se puede rescatar despejándole una diagonal con un avance de peón: acá e6-e5 o c6-c5 le abren a d7 la salida hacia f5 o hacia b7, sacándolo de detrás de la cadena que hoy lo deja con una sola jugada (Ac8). Cambiar alfiles (A) es justo lo que NO conviene cuando el propio es el peor —es el rival quien gana con ese cambio—; ignorar la pieza (C) deja una pieza floja para el resto de la partida; retroceder el alfil sin plan (D) lo confirma como una pieza mala en vez de rescatarlo.",
      fuente: "Posición ilustrativa: alfil de casillas claras encerrado por su propia cadena de peones centrales, con la salida disponible tras un avance de peón.",
    },
    ...
    },
    {
      ...
      fen: "r4rk1/pp1q1ppp/2pbp3/8/3P4/1P6/PBPQ1PPP/R4RK1 w - - 0 18",
      enunciado: "El alfil blanco de b2 apunta directo a g7, pero hoy tiene su propio peón de d4 tapándole a mitad de camino la diagonal larga. ¿Cuál es el plan correcto?",
      opciones: [
        "Cambiar ese alfil por el alfil negro de d6, que no hace nada especial.",
        "Preparar el cambio o el avance del peón de d4, para despejar la diagonal.",
    ...
    },
    {
      ...
      fen: "1kr4r/ppp1q1pp/3pbp2/8/4P3/6P1/PPP1QPBP/1KR4R w - - 0 20",
      enunciado: "El alfil blanco de g2 apunta directo a b7, pero hoy tiene su propio peón de e4 tapándole a mitad de camino la diagonal larga. ¿Cuál es el plan correcto?",
      opciones: [
        "Cambiar ese alfil por el alfil negro de e6, que no hace nada especial.",
        "Preparar el cambio o el avance del peón de e4, para despejar la diagonal.",
    ...
    },
    {
      ...
      fen: "r4rk1/pbpq1ppp/1p6/3p4/8/2PBP3/PP1Q1PPP/R4RK1 b - - 0 20",
      enunciado: "El alfil negro de b7 apunta directo a g2, pero hoy tiene su propio peón de d5 tapándole a mitad de camino la diagonal larga. ¿Cuál es el plan correcto?",
      opciones: [
        "Cambiar ese alfil por el alfil blanco de d3, que no hace nada especial.",
        "Preparar el cambio o el avance del peón de d5, para despejar la diagonal.",
    ...
    },
    {
      ...
      fen: "1kr4r/ppp1qpbp/6p1/4p3/8/3PBP2/PPP1Q1PP/1KR4R b - - 0 20",
      enunciado: "El alfil negro de g7 apunta directo a b2, pero hoy tiene su propio peón de e5 tapándole a mitad de camino la diagonal larga. ¿Cuál es el plan correcto?",
      opciones: [
        "Cambiar ese alfil por el alfil blanco de e3, que no hace nada especial.",
        "Preparar el cambio o el avance del peón de e5, para despejar la diagonal.",
    ...
    },
    {
      ...
      fen: "2kr1r2/pppq1ppp/1n1bp3/8/4P3/2NB4/PPP2PPP/2RQ1RK1 w - - 0 20",
      enunciado: "La columna «c» todavía está cerrada por los peones, pero un solo cambio la abriría de par en par frente al rey negro, enrocado largo. ¿Qué plan tiene más sentido para las blancas?",
      opciones: [
      ...
      correcta: 0,
      explica: "Cuando una columna que se va a abrir apunta directo al rey rival, conviene ser quien la abre y quien la ocupa primero: acá el cambio en c2-c7 deja al rey negro expuesto de inmediato, así que llegar antes con la torre decide quién la controla. Evitar el cambio (B) deja la iniciativa en manos del rival; enrocar largo (C) ni siquiera es legal —las blancas ya enrocaron— y aunque lo fuera, no resuelve nada de la columna «c» en sí; cambiar damas (D) apaga precisamente el ataque que la columna abierta puede producir.",
      fuente: "Posición ilustrativa: columna «c» cerrada a punto de abrirse frente al rey enrocado largo.",
    },
    {
      id: "pp_columnas_03_h", area: "columnas_diagonales", dificultad: 3, turno: "blancas",
      fen: "2r1rk2/ppp1qppp/3pb1n1/8/3P4/4BN2/PPP2PPP/1KR1QR2 w - - 0 20",
      enunciado: "La columna «f» todavía está cerrada por los peones, pero un solo cambio la abriría de par en par frente al rey negro, enrocado corto. ¿Qué plan tiene más sentido para las blancas?",
      opciones: [
      ...
      correcta: 0,
      explica: "Cuando una columna que se va a abrir apunta directo al rey rival, conviene ser quien la abre y quien la ocupa primero: acá el cambio en f2-f7 deja al rey negro expuesto de inmediato, así que llegar antes con la torre decide quién la controla. Evitar el cambio (B) deja la iniciativa en manos del rival; enrocar corto (C) ni siquiera es legal —las blancas ya enrocaron— y aunque lo fuera, no resuelve nada de la columna «f» en sí; cambiar damas (D) apaga precisamente el ataque que la columna abierta puede producir.",
      fuente: "Posición ilustrativa: columna «f» cerrada a punto de abrirse frente al rey enrocado corto.",
    },
    {
      id: "pp_columnas_03_v", area: "columnas_diagonales", dificultad: 3, turno: "negras",
      fen: "2rq1rk1/ppp2ppp/2nb4/4p3/8/1N1BP3/PPPQ1PPP/2KR1R2 b - - 0 20",
      enunciado: "La columna «c» todavía está cerrada por los peones, pero un solo cambio la abriría de par en par frente al rey blanco, enrocado largo. ¿Qué plan tiene más sentido para las negras?",
      opciones: [
        "Provocar el cambio y ocupar la columna «c» antes que el rival.",
        "Evitar cualquier cambio en el ala de dama y jugar solo en el centro.",
        "Enrocar largo, para alejar al propio rey de esa columna.",
      ...
      correcta: 0,
      explica: "Cuando una columna que se va a abrir apunta directo al rey rival, conviene ser quien la abre y quien la ocupa primero: acá el cambio en c7-c2 deja al rey blanco expuesto de inmediato, así que llegar antes con la torre decide quién la controla. Evitar el cambio (B) deja la iniciativa en manos del rival; enrocar largo (C) ni siquiera es legal —las negras ya enrocaron— y aunque lo fuera, no resuelve nada de la columna «c» en sí; cambiar damas (D) apaga precisamente el ataque que la columna abierta puede producir.",
      fuente: "Posición ilustrativa: columna «c» cerrada a punto de abrirse frente al rey enrocado largo.",
    },
    {
      id: "pp_columnas_03_hv", area: "columnas_diagonales", dificultad: 3, turno: "negras",
      fen: "1kr1qr2/ppp2ppp/4bn2/3p4/8/3PB1N1/PPP1QPPP/2R1RK2 b - - 0 20",
      enunciado: "La columna «f» todavía está cerrada por los peones, pero un solo cambio la abriría de par en par frente al rey blanco, enrocado corto. ¿Qué plan tiene más sentido para las negras?",
      opciones: [
        "Provocar el cambio y ocupar la columna «f» antes que el rival.",
        "Evitar cualquier cambio en el ala de rey y jugar solo en el centro.",
        "Enrocar largo, para alejar al propio rey de esa columna.",
      ...
      correcta: 0,
      explica: "Cuando una columna que se va a abrir apunta directo al rey rival, conviene ser quien la abre y quien la ocupa primero: acá el cambio en f7-f2 deja al rey blanco expuesto de inmediato, así que llegar antes con la torre decide quién la controla. Evitar el cambio (B) deja la iniciativa en manos del rival; enrocar corto (C) ni siquiera es legal —las negras ya enrocaron— y aunque lo fuera, no resuelve nada de la columna «f» en sí; cambiar damas (D) apaga precisamente el ataque que la columna abierta puede producir.",
      fuente: "Posición ilustrativa: columna «f» cerrada a punto de abrirse frente al rey enrocado corto.",
    },
    ...
    },
    {
      ...
      enunciado: "Un avance anterior de peones blancos en el ala de rey dejó huecos permanentes alrededor del rey enrocado. ¿Cuál es el mejor plan para las negras?",
      opciones: [
        "Cambiar todas las piezas posibles para llegar a un final tranquilo.",
        "Llevar piezas —dama y torre incluidas— hacia el ala de rey rival.",
        "Avanzar los propios peones del ala de dama, sin mirar el rey rival.",
    ...
    },
    {
      ...
      enunciado: "Un avance anterior de peones blancos en el ala de dama dejó huecos permanentes alrededor del rey enrocado. ¿Cuál es el mejor plan para las negras?",
      opciones: [
        "Cambiar todas las piezas posibles para llegar a un final tranquilo.",
        "Llevar piezas —dama y torre incluidas— hacia el ala de dama rival.",
        "Avanzar los propios peones del ala de rey, sin mirar el rey rival.",
    ...
    },
    {
      ...
      fen: "r1br2k1/1p3ppp/p1pp1n2/8/P1P1P3/2NB4/5PPP/R2R2K1 w - - 0 22",
      enunciado: "Las blancas tienen MENOS peones que el rival en el ala de dama (a4, c4 contra a6, b7, c6), pero eso no impide avanzar a5 y restarle espacio a las piezas negras de ese flanco: es un ataque de minoría. ¿Cuál es el plan correcto?",
      opciones: [
      ...
      correcta: 1,
      explica: "En un ataque de minoría, quien tiene MENOS peones en el flanco es quien ataca: a4-a5 clava el peón de a6 y, tarde o temprano, obliga a un cambio que le deja a alguno de los peones negros restantes —b7 o c6— sin otro peón propio que lo defienda. Abandonar el flanco (A) desperdicia la debilidad que ya se puede provocar; cambiar el peón (C) elimina precisamente la base del plan; retirarlo (D) renuncia al espacio sin ninguna razón.",
      fuente: "Posición ilustrativa: ataque de minoría en el ala de dama, típico de la estructura Carlsbad.",
    },
    {
      id: "pp_espacio_03_h", area: "espacio_restriccion", dificultad: 2, turno: "blancas",
      fen: "1k2rb1r/ppp3p1/2n1pp1p/8/3P1P1P/4BN2/PPP5/1K2R2R w - - 0 20",
      enunciado: "Las blancas tienen MENOS peones que el rival en el ala de rey (h4, f4 contra h6, g7, f6), pero eso no impide avanzar h5 y restarle espacio a las piezas negras de ese flanco: es un ataque de minoría. ¿Cuál es el plan correcto?",
      opciones: [
      ...
      correcta: 1,
      explica: "En un ataque de minoría, quien tiene MENOS peones en el flanco es quien ataca: h4-h5 clava el peón de h6 y, tarde o temprano, obliga a un cambio que le deja a alguno de los peones negros restantes —g7 o f6— sin otro peón propio que lo defienda. Abandonar el flanco (A) desperdicia la debilidad que ya se puede provocar; cambiar el peón (C) elimina precisamente la base del plan; retirarlo (D) renuncia al espacio sin ninguna razón.",
      fuente: "Posición ilustrativa: ataque de minoría en el ala de rey, típico de la estructura Carlsbad.",
    },
    {
      id: "pp_espacio_03_v", area: "espacio_restriccion", dificultad: 2, turno: "negras",
      fen: "r2r2k1/5ppp/2nb4/p1p1p3/8/P1PP1N2/1P3PPP/R1BR2K1 b - - 0 20",
      enunciado: "Las negras tienen MENOS peones que el rival en el ala de dama (a5, c5 contra a3, b2, c3), pero eso no impide avanzar a4 y restarle espacio a las piezas blancas de ese flanco: es un ataque de minoría. ¿Cuál es el plan correcto?",
      opciones: [
        "Abrir el centro con d5-d4, dejando de lado el ala de dama.",
        "Avanzar a5-a4, fijando los peones blancos de ese flanco.",
        "Cambiar el peón «a» propio por el peón «a» rival, sin más.",
        "Retirar el peón a a6, para no arriesgarlo tan adelantado.",
      ],
      correcta: 1,
      explica: "En un ataque de minoría, quien tiene MENOS peones en el flanco es quien ataca: a5-a4 clava el peón de a3 y, tarde o temprano, obliga a un cambio que le deja a alguno de los peones blancos restantes —b2 o c3— sin otro peón propio que lo defienda. Abandonar el flanco (A) desperdicia la debilidad que ya se puede provocar; cambiar el peón (C) elimina precisamente la base del plan; retirarlo (D) renuncia al espacio sin ninguna razón.",
      fuente: "Posición ilustrativa: ataque de minoría en el ala de dama, típico de la estructura Carlsbad.",
    },
    {
      id: "pp_espacio_03_hv", area: "espacio_restriccion", dificultad: 2, turno: "negras",
      fen: "1k2r2r/ppp5/4bn2/3p1p1p/8/2N1PP1P/PPP3P1/1K2RB1R b - - 0 20",
      enunciado: "Las negras tienen MENOS peones que el rival en el ala de rey (h5, f5 contra h3, g2, f3), pero eso no impide avanzar h4 y restarle espacio a las piezas blancas de ese flanco: es un ataque de minoría. ¿Cuál es el plan correcto?",
      opciones: [
        "Abrir el centro con e5-e4, dejando de lado el ala de rey.",
        "Avanzar h5-h4, fijando los peones blancos de ese flanco.",
        "Cambiar el peón «h» propio por el peón «h» rival, sin más.",
        "Retirar el peón a h6, para no arriesgarlo tan adelantado.",
      ],
      correcta: 1,
      explica: "En un ataque de minoría, quien tiene MENOS peones en el flanco es quien ataca: h5-h4 clava el peón de h3 y, tarde o temprano, obliga a un cambio que le deja a alguno de los peones blancos restantes —g2 o f3— sin otro peón propio que lo defienda. Abandonar el flanco (A) desperdicia la debilidad que ya se puede provocar; cambiar el peón (C) elimina precisamente la base del plan; retirarlo (D) renuncia al espacio sin ninguna razón.",
      fuente: "Posición ilustrativa: ataque de minoría en el ala de rey, típico de la estructura Carlsbad.",
    },
    ...
    },
    {
      ...
      enunciado: "Las negras tienen a7, b5, c5 contra a2, b2 blancos: si avanzan b5-b4 crean un peón pasado potencial pero también le abren al rival la casilla c4 para su caballo. ¿Qué plan conviene?",
      opciones: [
    ...
    },
    {
      ...
      enunciado: "Las negras tienen h7, g5, f5 contra h2, g2 blancos: si avanzan g5-g4 crean un peón pasado potencial pero también le abren al rival la casilla f4 para su caballo. ¿Qué plan conviene?",
      opciones: [
    ...
    },
    {
      ...
      fen: "3r2k1/pp3pp1/2p1p3/8/3PP3/8/PP3PP1/3R2K1 w - - 0 30",
      enunciado: "Es un final de torres con material parejo, pero las blancas tienen una mayoría de peones en el centro y el ala de rey (4 contra 3), mientras que en el ala de dama es el negro quien tiene la suya (3 contra 2). ¿Cuál es el plan correcto?",
      opciones: [
        ...
        "Avanzar los peones del ala de dama, donde es el rival quien tiene la mayoría.",
        "Llevar el rey al ala de dama de inmediato, dejando el centro de lado.",
      ],
      correcta: 1,
      explica: "Con una mayoría de peones en un sector, el plan de final es convertirla en un peón pasado: acá el 4 contra 3 del centro y el ala de rey es justo donde hay que avanzar, con las torres todavía en el tablero apoyando ese avance y compitiendo por la columna abierta que se genere. Cambiar torres para ir a un final de peones (A) no está mal en sí, pero renunciar a la actividad de la torre antes de tiempo simplifica la tarea del rival; jugar en el flanco donde el rival tiene la mayoría (C) le hace el trabajo al contrario; abandonar el centro (D) es lo mismo.",
      fuente: "Posición ilustrativa: final de torres con mayorías cruzadas —4 contra 3 en un flanco, 3 contra 2 en el otro—, situación clásica para decidir cuál conviene avanzar.",
    },
    {
      id: "pp_final_02_h", area: "final_transformacion", dificultad: 2, turno: "blancas",
      fen: "1k2r3/1pp3pp/3p1p2/8/3PP3/8/1PP3PP/1K2R3 w - - 0 20",
      enunciado: "Es un final de torres con material parejo, pero las blancas tienen una mayoría de peones en el centro y el ala de dama (4 contra 3), mientras que en el ala de rey es el negro quien tiene la suya (3 contra 2). ¿Cuál es el plan correcto?",
      opciones: [
        "Cambiar la torre propia por la rival, para llegar a un final de peones.",
        "Avanzar la mayoría del centro y el ala de dama, con las torres en juego.",
        "Avanzar los peones del ala de rey, donde es el rival quien tiene la mayoría.",
    ...
    },
    {
      ...
      fen: "3r2k1/pp3pp1/8/3pp3/8/2P1P3/PP3PP1/3R2K1 b - - 0 20",
      enunciado: "Es un final de torres con material parejo, pero las negras tienen una mayoría de peones en el centro y el ala de rey (4 contra 3), mientras que en el ala de dama es el blanco quien tiene la suya (3 contra 2). ¿Cuál es el plan correcto?",
      opciones: [
        "Cambiar la torre propia por la rival, para llegar a un final de peones.",
        "Avanzar la mayoría del centro y el ala de rey, con las torres en juego.",
        "Avanzar los peones del ala de dama, donde es el rival quien tiene la mayoría.",
    ...
    },
    {
      ...
      fen: "1k2r3/1pp3pp/8/3pp3/8/3P1P2/1PP3PP/1K2R3 b - - 0 20",
      enunciado: "Es un final de torres con material parejo, pero las negras tienen una mayoría de peones en el centro y el ala de dama (4 contra 3), mientras que en el ala de rey es el blanco quien tiene la suya (3 contra 2). ¿Cuál es el plan correcto?",
      opciones: [
        "Cambiar la torre propia por la rival, para llegar a un final de peones.",
        "Avanzar la mayoría del centro y el ala de dama, con las torres en juego.",
        "Avanzar los peones del ala de rey, donde es el rival quien tiene la mayoría.",
